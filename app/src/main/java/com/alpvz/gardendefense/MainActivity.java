...
smallAt(c,"PF "+plantFood,getWidth()*.87f,getHeight()*.045f,Color.WHITE); if(System.currentTimeMillis()<pfMsgUntil)center(c,pfMsg,getWidth()*.72f,getHeight()*.16f,getHeight()*.035f,Color.YELLOW);
...
hp=maxHp;bossShot=System.currentTimeMillis();}}
