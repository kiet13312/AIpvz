...
public class MainActivity extends Activity {
    ...
    class GameView extends View {
        ...
        float left,top,cw,ch; int screen=0,level=1,unlocked=1,selected=0,skill=0; int sun=500,coin=99999,food=3,killed=0,spawned=0; long last,spawnAt,levelStart; boolean paused=false,win=false,lose=false; Zombie houseZombie;
        ...
        void startLevel(int l){level=Math.max(1,Math.min(MAX,l));screen=1;paused=false;win=false;lose=false;houseZombie=null;selected=PEA;skill=0;tool=0;sun=500;coin=99999;food=3;spawned=0;killed=0;zs.clear();shots.clear();mines.clear();coins.clear();for(int r=0;r<R;r++)for(int c=0;c<C;c++)plants[r][c]=null;resetMowers();last=spawnAt=levelStart=System.currentTimeMillis();invalidate();}
